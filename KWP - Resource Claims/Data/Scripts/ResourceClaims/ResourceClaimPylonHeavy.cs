...
{
    public class ResourceClaimPylonHeavy : ResourceClaimPylonBase
    {
        ...
        public ResourceClaimPylonHeavy(IMyConveyorSorter resourcePylon, ResourceClaimPylonLogic logic) 
            : base(resourcePylon, logic)
        {
            _miningZoneRadius = 350.0f;
            ...
            _interferencePenaltyFactor = 0.15f;
